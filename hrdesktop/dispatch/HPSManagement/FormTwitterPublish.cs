...
namespace HPSManagement
{
    ...
    public partial class FormTwitterPublish : Form
    {
        ...
        public FormTwitterPublish(CmWinServiceAPI db, TwitterService service)
        {
            this.db = db;
        ...
        {
            if (db.GetMediaPublishVW(0, 0, "*", "MediaType='TWITTER' AND 发行状态='未发行'", "", ref ds_media)
