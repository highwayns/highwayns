...
import com.highwayns.ht.config.UrlConstant;
import com.highwayns.ht.imservice.callback.ListenerQueue;
import com.highwayns.ht.imservice.callback.Packetlistener;
import com.highwayns.ht.imservice.event.SocketEvent;
import com.highwayns.ht.imservice.network.MsgServerHandler;
import com.highwayns.ht.imservice.network.SocketThread;
import com.highwayns.ht.protobuf.IMBaseDefine;
import com.highwayns.ht.protobuf.IMOther;
import com.highwayns.ht.protobuf.base.DataBuffer;
import com.highwayns.ht.protobuf.base.DefaultHeader;
...
public class IMSocketManager extends IMManager {
    ...
    public void sendRequest(GeneratedMessageLite requset,int sid,int cid,Packetlistener packetlistener){
        ...
        try{
            //组装包头 header
            com.highwayns.ht.protobuf.base.Header header = new DefaultHeader(sid, cid);
    ...
    public void packetDispatch(ChannelBuffer channelBuffer){
        ...
        com.highwayns.ht.protobuf.base.Header header = new com.highwayns.ht.protobuf.base.Header();
