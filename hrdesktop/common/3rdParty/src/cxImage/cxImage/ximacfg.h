...
#define CXIMAGE_SUPPORT_TRANSFORMATION 0 // geometric transformations
#define CXIMAGE_SUPPORT_DSP            0 // image processing
#define CXIMAGE_SUPPORT_LAYERS		   0 //
#define CXIMAGE_SUPPORT_INTERPOLATION  0// interpolation functions 

#define CXIMAGE_SUPPORT_DECODE	1		// load ...
#define CXIMAGE_SUPPORT_ENCODE	1		// save ... <vho><T.Peck>
#define	CXIMAGE_SUPPORT_WINDOWS 1		// Draw ...
