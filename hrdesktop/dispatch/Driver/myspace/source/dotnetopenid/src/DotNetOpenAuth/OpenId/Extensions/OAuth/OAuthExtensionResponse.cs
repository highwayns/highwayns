...
{
    public sealed class OAuthExtensionResponse: ExtensionBase {
        ...
        {
            if (typeUri == Constants.oauth_ns && baseMessage is PositiveAssertionResponse)
            {
                return new OAuthExtensionResponse();
            }

            return null;
        };

        public OAuthExtensionResponse()
