...
{
    public sealed class OAuthExtensionRequest : ExtensionBase
    {
        ...
        internal static readonly OpenIdExtensionFactory.CreateDelegate Factory = (typeUri, data, baseMessage) =>
        {
            ...
            {
                return new OAuthExtensionRequest();
            }
        ...
        /// 
        /// </summary>
        public OAuthExtensionRequest() : base(new Version(1, 0), Constants.oauth_ns, additionalTypeUris) {}

        public OAuthExtensionRequest(string oAuthConsumerKey)
