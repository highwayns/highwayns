function tagso(templatedir,dir,jobslisturl,getarr,district_id)
{
	...
	if (get[4]=='')
	{
		for(var i=0;i<HW_jobtag.length;i++)
		{
		arr    =HW_jobtag[i].split(",");
	...
	function search_location()
	{
		...
		var jobtag=$("#searcform input[name=jobtag]").val();
		var inforow=$("#searcform input[name=inforow]").val();
		var page=$("#searcform input[name=page]").val();
		$.get(dir+"plus/ajax_search_location.php", {"act":"HW_jobtag","category":category,"subclass":subclass,"district":district,"sdistrict":sdistrict,"jobtag":jobtag,"inforow":inforow,"page":page},
