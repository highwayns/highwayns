...
(NUll, 'HW_indexcentreimg', 2, '首页中部格子广告', 1, 30),
(NUll, 'HW_newsbanner', 2, '资讯首页中间横幅', 1, 0),
(NUll, 'HW_indexfootimg', 2, '首页下方格子广告位', 1, 0),
(NUll, 'HW_indexfloat', 5, '首页对联广告', 1, 0),
(NUll, 'HW_indexfootbanner', 2, '首页底部横幅广告', 1, 0),
(NUll, 'HW_indexcenter', 2, '首页中部横幅广告', 1, 0),
(NUll, 'HW_indexrecommend', 2, '首页上部名企推荐广告位', 1, 0),
(NUll, 'HW_indextopimg', 2, '首页上方横幅广告位', 1, 0),
(NUll, 'HW_yellowpage', 2, '黄页右侧广告位', 1, 0),
(NUll, 'HW_newsbanner2', 2, '资讯首页中间横幅2', 1, 0),
(NUll, 'HW_company_index', 2, '企业会员中心中部广告位', 1, 0),
(NUll, 'HW_indexcentreimg_230x58', 2, '首页中部格子广告230x58', 1, 0),
(NUll, 'HW_floor_img1', 2, '首页楼层广告1', 1, 0),
(NUll, 'HW_floor_img2', 2, '首页楼层广告2', 1, 0),
(NUll, 'HW_floor_img3', 2, '首页楼层广告3', 1, 0),
(NUll, 'HW_floor_img4', 2, '首页楼层广告4', 1, 0),
...
(291, 0, 'HW_language_level', '入门', 0, 'r', '', '', ''),
