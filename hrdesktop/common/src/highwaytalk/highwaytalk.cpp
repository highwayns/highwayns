...
ChighwaytalkApp::ChighwaytalkApp()
:m_pMainDialog(0)
{
	m_dwRestartManagerSupportFlags = AFX_RESTART_MANAGER_SUPPORT_RESTART;
}

ChighwaytalkApp theApp;

BOOL ChighwaytalkApp::InitInstance()
{
	...
	if (_IsHaveInstance())
	{
		...
		HWND hwndMain = FindWindow(_T("highwaytalkMainDialog"), NULL);
		if (hwndMain)
		{
...
BOOL ChighwaytalkApp::_DestroyMainDialog()
{
...
BOOL ChighwaytalkApp::_CreateMainDialog()
{
...
BOOL ChighwaytalkApp::ExitInstance()
{
...
BOOL ChighwaytalkApp::_CreateUsersFolder()
{
...
#endif
BOOL ChighwaytalkApp::_IsHaveInstance()
{
	// 单实例运行
