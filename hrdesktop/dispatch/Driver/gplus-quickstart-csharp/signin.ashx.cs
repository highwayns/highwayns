...
namespace GPlusQuickstartCsharp
{
    ...
    public class Signin : IHttpHandler, IRequiresSessionState, IRouteHandler
    {
        ...
        static public string CLIENT_ID = "859090616008.apps.googleusercontent.com";
        static public string CLIENT_SECRET = "kx-Iwp-TOXzc26wKpTff7dav";

        // Configuration that you probably don't need to change.
        static public string APP_NAME = "CJW";
