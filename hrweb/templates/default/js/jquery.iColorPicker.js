...
this.iColorPicker = function() {
    jQuery("input.iColorPicker").each(function(i) {
        ...
        jQuery(this).css("backgroundColor", jQuery(this).val()).after('<a href="javascript:void(null)" class="colorimg"  id="icp_' + this.id + '" onclick="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\')"></a><span style="clear:both"></span>')
    })
};
jQuery(function() {
    iColorPicker();
