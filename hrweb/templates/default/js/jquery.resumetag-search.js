function allaround(dir,getstr){
	...
	function search_location() {
		...
		$.get(dir+"plus/ajax_search_location.php", {"act":"HW_resumetag","key":key,"tag":tag,"jobcategory":jobcategory,"citycategory":citycategory,"sort":sort_1,"page":page},
...
function fillTag(fillID){
	var tradli = '';
	$.each(HW_resumetag, function(index, val) {
		if(val) {
			var trads = val.split(",");
